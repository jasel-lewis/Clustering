...
public class CentroidLinkageClustering {
	...
	public static void main(String[] args) throws InvalidEducationException {
		...
		clusters.add(new Cluster(new Instance("a", 0.1167, "BS", 0.1321, 0.0538, 0.0787)));
		clusters.add(new Cluster(new Instance("b", 0.0833, "MS", 0.1132, 0.0000, 0.0562)));
		clusters.add(new Cluster(new Instance("c", 0.1000, "BS", 0.0943, 0.0645, 0.1124)));
		clusters.add(new Cluster(new Instance("d", 0.1833, "BS", 0.1321, 0.3326, 0.1685)));
		clusters.add(new Cluster(new Instance("e", 0.1500, "MS", 0.1321, 0.1613, 0.1124)));
		clusters.add(new Cluster(new Instance("f", 0.1000, "MS", 0.1509, 0.0215, 0.0787)));
		clusters.add(new Cluster(new Instance("g", 0.1333, "BS", 0.0943, 0.2151, 0.2247)));
		clusters.add(new Cluster(new Instance("h", 0.1333, "MS", 0.1509, 0.1613, 0.1685)));
		
		for (int i = 0; i < clusters.size(); i++) {
			for (int j = i + 1; j < clusters.size(); j++) {
				dist = distance(clusters.get(i).getCentroid(), clusters.get(j).getCentroid(cluster) =);
